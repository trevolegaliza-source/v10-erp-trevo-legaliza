-- =============================================
-- INTEGRAÇÃO ASAAS — PR 1: infraestrutura
-- =============================================
-- Objetivo: guardar IDs e URLs devolvidos pela API do Asaas
-- para cada cliente (Customer) e cobrança (Payment).
-- =============================================

-- 1. CLIENTES: vínculo com customer do Asaas
...
-- 2. COBRANCAS: dados do Payment criado no Asaas
...
-- 3. LOG de eventos de webhook (audit + idempotência)
...
-- 4. Atualizar RPC pública pra retornar dados do Asaas quando existirem

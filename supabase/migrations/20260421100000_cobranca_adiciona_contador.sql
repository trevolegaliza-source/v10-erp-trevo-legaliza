-- =============================================
-- Adicionar cliente_nome_contador na RPC pública
-- =============================================
-- Objetivo: mostrar nome do contador cadastrado no cliente na
-- saudação da página pública (mensagem personalizada da Dani).
-- =============================================
